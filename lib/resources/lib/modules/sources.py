...
class sources:
    ...
    def getConstants(self):
        self.itemProperty = 'plugin.video.leviticus.container.items'

        self.metaProperty = 'plugin.video.leviticus.container.meta'

        from resources.lib.sources import sources
        try: from lambdascrapers import sources
        except: pass
